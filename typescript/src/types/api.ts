...
export interface paths {
  ...
  "/document/batch": {
    ...
    post: operations["DocumentController_createBatch"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/document/batch/{batchId}": {
    ...
    /** Get the results of a batch of documents */
    get: operations["DocumentController_getDocumentsForBatch"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    // Supporting types for 2025 batch response
    ...
    TransactionStepDTO: {
       ...
       * @example { alternativeCategories: [{ urn: "urn:carbonapi:emission-factor:flights", confidence: 0.95 }] }
       */
      meta?: unknown;
    };
    ...
    DocumentResponseItem: {
       ...
       * @example ["Calculate the emissions for the electricity used.", "Apply transmission and distribution losses."]
       */
      steps: string[];
      /**
...
export interface operations {
  DocumentController_createBatch: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
  ...
  DocumentController_getDocumentsForBatch: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody?: never;
    responses: {
      /** @description The results of the document batch */
      200: {
        headers: {
          [name: string]: unknown;
        };
