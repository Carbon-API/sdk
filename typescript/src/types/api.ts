...
export interface components {
  schemas: {
    ...
    /**
     * @description Provide a suggested document category. If set, then CarbonAPI will use this category as a hint to the processing pipeline to constrain factor choice.
     * @enum {string}
     */
    DocumentSupportedCategory:
      | "ELECTRICITY"
      | "GAS_NATURAL"
      | "STATIONARY_COMBUSTION"
      | "GAS_INDUSTRIAL_OR_MEDICAL"
      | "FUEL"
      | "WASTE"
      | "TRAVEL_AIR_TICKET"
    ...
    DocumentDTO: {
       ...
       * @example FUEL
       */
      categoryHint?: components["schemas"]["DocumentSupportedCategory"];
      /**
     ...
     * @enum {string}
     */
    DocumentLineItemErrorCode:
      | "LINE_ITEM_FACTOR_NOT_MATCHED"
      | "LINE_ITEM_NO_FACTOR_SELECTED"
      | "LINE_ITEM_AIRPORT_NOT_FOUND";
    ...
    DocumentProcessingErrorCode:
      ...
      | "DOCUMENT_UNSUPPORTED_DOCUMENT"
      | "DOCUMENT_LINE_ITEM_FAILED"
      | "DOCUMENT_UNKNOWN_ERROR";
    DocumentResponseDTO: {
      /**
      ...
      failureReason?: string;
      /**
       * @description The fileId supplied when the document was submitted, echoed back so results can be correlated to the caller's own files. Absent if no fileId was supplied.
       * @example e2b1c0f2-4a3d-4a1e-9f0b-9c8d7e6f5a4b
       */
      fileId?: string;
      /**
       * @description The metadata supplied when the document was submitted, echoed back so results can be correlated to the caller's own records.
       * @example {
       *       "key": "value"
       *     }
       */
